    ...
    it('should return correct notes', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then((res) => {
          ...
          expect(user.id).to.eql(data.userId.toString());
    ...
    it('should create and return a new item when provided valid data', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res.body).to.have.all.keys('userId', 'id', 'title', 'content', 'createdAt', 'updatedAt', 'tags');
    ...
    it('should update the note when provided valid data', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then(function (res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.have.all.keys('userId', 'id', 'title', 'content', 'createdAt', 'updatedAt', 'folderId', 'tags');
          expect(res.body.id).to.equal(data.id);
    ...
    it('should delete an existing document and respond with 204', function () {
      ...
      return Note.findOne({userId: user.id})
        ...
        .then(function (res) {
          ...
          return Note.count({ _id: data.id, userId: user.id });
        })
        .then(count => {
